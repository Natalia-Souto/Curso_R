# Script de analise grafica dos dados de cestes
...
# dados que vêm no summary do objeto rich também podem ser observados realizando um boxplot
boxplot(rich)

# mudar os rótulos do eixo y para que eles fiquem horizontais.
# A função par() lista os parâmetros mais usados para estas modificações
?par
...
## acrescentar a coluna de riqueza à tabela de variáveis ambientais num objeto novo que se chame localidades
...
## Vamos criar um data.frame com a média e desvio padrão de cinco variáveis.
